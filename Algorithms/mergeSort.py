...
Merge sort is a divide-and-conquer algorithm that divides a list into two halves, sorts each half, and then merges the sorted halves to produce a single sorted list. The merge sort is a stable sort, meaning that the relative order of equal elements is preserved in the sorted list. It's the most reliable sorting algorithm and is often used as the default sorting algorithm in many programming languages.
...
def mergeSort(values):
  ...
  left_index = 0
  right_index = 0
  # We iterate over the two sub-lists and merge them by always selecting the smallest element
